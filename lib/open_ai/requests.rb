...
require File.expand_path('../requests/chat_completions', __FILE__)
require File.expand_path('../requests/assistants', __FILE__)
require File.expand_path('../requests/models', __FILE__)
require File.expand_path('../requests/threads', __FILE__)
require File.expand_path('../requests/thread_messages', __FILE__)
require File.expand_path('../requests/thread_runs', __FILE__)
