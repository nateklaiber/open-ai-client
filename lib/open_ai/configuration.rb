...
module OpenAi
  class Configuration
    ...
    #
    # @example
    #   configuration = OpenAi::Configuration.new(access_token: 'abcd')
    #
    ...
    #
    # @return [OpenAi::Configuration] Instance of the object
    #
    def initialize(attributes={})
      self.class.keys.each do |key|
        instance_variable_set(:"@#{key}", (attributes[key] || OpenAi::Configurations::Default.options[key]))
      end
    end
    ...
    # been initialized.
    #
    # @return [OpenAi::Configuration] The configuration instance
    def configure(&block)
      yield(self)
    end
    ...
    # default state
    #
    # @return [OpenAi::Configuration] The configuration with Defaults applied
    def reset!
      self.class.keys.each do |key|
        instance_variable_set(:"@#{key}", OpenAi::Configurations::Default.options[key])
      end
    end
    alias :setup :reset!
  end
