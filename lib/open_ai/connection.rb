...
module OpenAi
  class Connection < SimpleDelegator
    ...
    #
    # @example
    #   connection = OpenAi::Connection.new(url: 'http://example.com') do |conn|
    #     conn.adapter(OpenAi::Connection.default_adapter)
    #   end
    #
    #   @connection.headers['Authorization'] = "Bearer 1234"
    #
    # @return [OpenAi::Connection] Faraday Connection Delegator
