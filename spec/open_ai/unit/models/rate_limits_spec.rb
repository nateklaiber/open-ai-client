RSpec.describe(OpenAi::Models::RateLimits) do
  ...
  it "returns the rate limit for requests" do
    expect(subject.retrieve('x-ratelimit-limit-requests')).to be_kind_of(OpenAi::Models::RateLimit)
  end

  it "returns nil if record not found" do
    expect(subject.retrieve('x-ratelimit-limit-requests-NOTFOUND')).to be_nil
  end
end
